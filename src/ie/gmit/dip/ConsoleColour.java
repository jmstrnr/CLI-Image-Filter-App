...
// ANSI escape codes to change the colors of the terminal output.
// Works for Unix shell prompts; however, it doesn't work for Windows Command Prompt or Powershell.
